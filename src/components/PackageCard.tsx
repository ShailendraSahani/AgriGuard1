    ...
    >
      <Card className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-modern overflow-hidden border-0 h-full relative">
        ...
        <CardHeader className="p-8 pb-4">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <div className="text-xs font-semibold text-yellow-700 bg-yellow-100 rounded-full inline-block px-2 py-1 mb-2">
                {planType}
              </div>
        ...
        <CardContent className="p-8 pt-0">
          ...
          {benefits && benefits.length > 0 && (
            <div className="text-xs text-gray-500">
              <span className="font-semibold text-gray-700">Benefits:</span> {benefits.join(', ')}
            </div>
          )}
        </CardContent>
        <CardFooter className="p-8 pt-0">
          <Button
            onClick={onSubscribe}
            className="w-full bg-gradient-to-r from-green-500 to-yellow-500 hover:opacity-90 text-white py-3 px-6 rounded-full font-bold shadow-modern hover:shadow-modern-lg transition-modern transform hover:scale-105"
          >
            Subscribe Now
          </Button>
        </CardFooter>
