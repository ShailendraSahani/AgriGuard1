...
import { User, Mail, Lock, MapPin, Phone, Sprout, Eye, EyeOff, Tractor, Wheat, Award } from 'lucide-react';
...
export default function FarmerSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push('/auth/signin?role=farmer');
      } else {
        alert('Signup failed');
      }
    } catch (error) {
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        >
          ...
          <p className="text-green-700">
            Start your farming journey with AgriGuard
          </p>
        </motion.div>
